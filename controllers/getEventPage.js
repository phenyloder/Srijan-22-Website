const events_list = [
    {
        ...
        content: {
            ...
            guidelines: ["-> You can participate individually or in a team of a maximum of 4 members.", "-> Please make your pitch-deck submission in this link: <a href=https://forms.gle/h8mLAiQwoX36cuVw8> here </a>", "The judges and the date for the final pitching round will be revealed soon!"],
            stages: [
                {
                    stage_id: "stage_1",
                    stage_name: "Stage 1 (Online Screening)",
                    stage_content: ["", ""],
                    stage_rules: ["Interested teams should submit a PPT about their prospective business plan/idea (in not more than 20 slides).", "The PPT should highlight the following points: Problem, Solution,  Market Size, Market analysis (TAM, SAM, SOM), Competition, traction (if you have any), Business model, Timing (why is it the right time to go ahead with the idea), team background, financial projections (if you have any), product demo (if possible), raise amount. Try to keep the ppt as simple and sleek as possible. Brevity will be appreciated.", "Please find all the resources to creating a good pitch deck here: <a href=https://bit.ly/pitchpleaseresources> here </a>"],
                },
                {
                    stage_id: "stage_2",
                    stage_name: "Stage 2 (Pitching)",
